...
You can also navigate to **"synthetic_images"** and **"synthetic_annotations"** directories that contain more than **100 synthetically generated images and corresponding annotations** which you can use to examine some of the results of synthetic data generation.
